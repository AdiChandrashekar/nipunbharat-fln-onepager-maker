...
COMPENDIUM = ROOT / "compendium.json"
...
def build(doc):
    ...
    manifest = {
        "_note": "Generated by onepager/scripts/tg_images.py from tg_image_sources.json. Crops are git-ignored; re-run the script to regenerate them.",
        "source_pdf": PDF.name,
        "images": images,
